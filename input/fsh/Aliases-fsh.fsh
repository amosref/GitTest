...
Alias: $vs-il-core-encounter-class =    http://fhir.health.gov.il/cs/il-core-encounter-class
Alias: $vs-il-core-virtual-type =       http://fhir.health.gov.il/cs/il-core-virtual-type
...
Alias: $vs-moh-discharge-disposition =  http://fhir.health.gov.il/ValueSet/moh-discharge-disposition
